...
class BeanCommands(bunny1.Bunny1Commands):
    ...
    def gcalpuppet(self, arg):
        """Tips and tricks for using Google Calendar at Puppet"""
        return "https://confluence.puppetlabs.com/display/IT/Calendars"

    def gcalhelp(self, arg):
        """Google calendar help page."""
        return "https://support.google.com/calendar/?hl=en#topic=3417969"
    ...
    def portal(self, arg):
        ...
        return "http://officemap.ops.puppetlabs.net/portal"
    ...
    def zendesk(self, arg):
        ...
        return "https://support.puppetlabs.com/"
...
<p><a href="https://github.com/highb/bean_bunny">""" + name + """</a> is a tool that lets you write smart bookmarks in python and then share them across all your browsers and with a group of people or the whole world. <a href="https://github.com/highb/bean_bunny">bean_bunny</a> is a fork of <a href="https://github.com/ccheever/bunny1">bunny1</a> which was developed at <a href="http://www.facebook.com/">Facebook</a> and was widely used there.</p>
